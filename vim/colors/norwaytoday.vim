...
call <SID>X("Folded","ffffff","000000","none")
call <SID>X("Function","ffffff","","italic")
call <SID>X("Identifier","eddd3d","","none")
call <SID>X("Ignore","e2e4e5","","none")
call <SID>X("IncSearch","e2e4e5","","none")
call <SID>X("Include","f8bb00","","none")
call <SID>X("Keyword","f8bb00","","none")
call <SID>X("Label","e2e4e5","","none")
call <SID>X("LineNr","ffffff","121e31","none")
...
call <SID>X("NonText","ffffff","","none")
call <SID>X("Normal","ffffff","121e31","none")
call <SID>X("Number","eddd3d","","none")
call <SID>X("Operator","ffffff","","none")
call <SID>X("PMenu","cccccc","333333","none")
call <SID>X("PMenuSbar","cccccc","dcdccc","none")
call <SID>X("PMenuSel","1a1a1a","","none")
call <SID>X("PMenuThumb","dcdccc","","none")
...
call <SID>X("Search","e2e4e5","685d9c","none")
call <SID>X("SignColumn","e2e4e5","","none")
call <SID>X("Special","ffffff","","none")
...
call <SID>X("Todo","ffffff","","none")
call <SID>X("Type","8aa6c1","","none")
...
call <SID>X("Visual","e2e4e5","685d9c","none")
